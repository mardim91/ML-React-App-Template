...
name_space = Namespace('germanyoutcome', description='Prediction APIs')
...
classifier = joblib.load('/home/mardim/diploma_app/ML-React-App-Template/service/apis/finalized_model_germany.sav')

teams_df = pd.read_csv('/home/mardim/diploma_app/ML-React-App-Template/service/apis/teams.csv')
x_test = pd.read_csv('/home/mardim/diploma_app/ML-React-App-Template/service/apis/test_df_germany.csv')
x_train = pd.read_csv('/home/mardim/diploma_app/ML-React-App-Template/service/apis/train_df_germany.csv')
selected_features = ['away_strength', 'away_ca_shotoffs', 'away_ca_pow2_shotoffs', 'away_ca_fouls', 'away_ca_ycards',
                     'away_ca_pow2_ycards', 'away_ca_sqrt_ycards', 'away_ma_rcards', 'away_ca_pow2_crosses', 'away_ma_possessions', 'away_ma_sqrt_possessions',
                     'home_elo_rate', 'home_ma_pow2_goals', 'home_ca_shotons', 'home_ca_sqrt_shotons', 'home_ma_rcards', 'home_ca_rcards', 'home_ca_pow2_rcards',
                     'home_ca_sqrt_rcards', 'home_ca_pow2_crosses'] 
